...
# Contains two classes: Lab2Topology and Lab2
...
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# Lab2Topology - class inheriting from mininet.topo.Topo, defines the network topology
class Lab2Topology( Topo ):
...
#------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------
# Lab2 - class running the Mininet environment and launching the servers
class Lab2():
#------------------------------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------------------------------
	...
	def run(self):
		...
		topology = Lab2Topology(nbOfServersPerRegion, nbOfClientsPerRegion, nbOfRegions)
